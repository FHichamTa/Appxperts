...
<html lang="fr">
    ...
    <body>
        ...
        $cnxBDD = connexion(); 
        ?>
        <h1 class="mx-10 my-5 text-3xl font-bold">Modification de l'étape n°<?php echo($ETPID);?> de la tournée n°<?php echo($TRNNUM);?></h1>
        <div class="mx-10 my-5 grid grid-cols-2 gap-10">
            <form action="../tournees/tournees_fiche.php?methode=create&TRNNUM=<?php echo($TRNNUM);?>" method="POST">
                <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-10 mb-6">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="" class="bg-green-700 text-white text-sm rounded-lg block w-full p-2.5"  value="" required>
                    </div>  
                </div>
                <div class="grid grid-cols-2 gap-10 mb-6">
                    <div>
